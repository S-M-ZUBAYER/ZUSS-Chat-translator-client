...
function App() {
 ...
 // fetch the api to use post method the get the response from OpenAI
    ...
    // let apiUrl = `https://zuss-translator-server-site-s-m-zubayer.vercel.app/translateAll`;
    // let apiUrl = `http://localhost:5000/translate`;
    let apiUrl = `https://zuss-chat-translator-server.vercel.app/translate`;
    if(!targetLan){
      notify();
    }
    fetch(apiUrl, {
    ...
    // let apiUrlEng = `https://zuss-translator-server-site-s-m-zubayer.vercel.app/translateEng`;
    // let apiUrlEng = `http://localhost:5000/translate`;
    let apiUrlEng = `https://zuss-chat-translator-server.vercel.app/translate`;
    ...
    <div className="App md:h-screen flex justify-center items-center bg-lime-300">
      ...
      <div className=" ">
        ...
        <div className=' bg-white md:flex rounded-lg p-5'>  
          <div>
            <textarea placeholder="please type here" onChange={handleToCollectText} className="border-2 border-slate-600 rounded-t-lg md:rounded-t-none md:rounded-tl-lg p-2  mt-2 md:ml-2 h-96  w-72 md:w-64 lg:w-72  block"></textarea>
          ...
          <div>
            <div placeholder="Translation" id="mid-text" className="border-2 text-start rounded-t-lg  md:rounded-t-none border-slate-600 p-2  mt-2 h-96 w-72 md:w-64 lg:w-72 block">
              {
          ...
          <div>
            <div placeholder="Translation" id="to-text" className="border-2 text-start border-slate-600 rounded-t-lg md:rounded-none md:rounded-tr-lg p-2 mt-2 mr-2 h-96  w-72 md:w-64 lg:w-72 block">
            {
